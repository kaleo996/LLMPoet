...
# Ping-tone rhyme groups (平声韵部) for regulated verse (格律诗)
PING_RHYME_GROUP_NAMES = (
    # 上平聲部 (15)
    "上平聲一東", "上平聲二冬", "上平聲三江", "上平聲四支", "上平聲五微",
    "上平聲六魚", "上平聲七虞", "上平聲八齊", "上平聲九佳", "上平聲十灰",
    "上平聲十一真", "上平聲十二文", "上平聲十三元", "上平聲十四寒", "上平聲十五刪",
    # 下平聲部 (15)
    "下平聲一先", "下平聲二蕭", "下平聲三肴", "下平聲四豪", "下平聲五歌",
    "下平聲六麻", "下平聲七陽", "下平聲八庚", "下平聲九青", "下平聲十蒸",
    "下平聲十一尤", "下平聲十二侵", "下平聲十三覃", "下平聲十四鹽", "下平聲十五咸",
)
